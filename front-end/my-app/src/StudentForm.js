...
function StudentForm() {
  ...
  const renderSignupStep = () => {
    const steps = [
      ...
      { question: 'What university do you go to?', name: 'university', progress: 32 },
      { question: 'What major are you?', name: 'major', progress: 48 },
    ...
    return (
      <Box>
        <Progress value={progress} height="16px" colorScheme="blue" borderRadius="full" boxShadow="md"  mb={8} />
